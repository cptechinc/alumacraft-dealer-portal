<html class="js">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="https://www.alumacraft.com/css/settings.css?v=1" media="screen">
         <link rel="stylesheet" type="text/css" href="https://www.alumacraft.com/css/form.css?v=1">
            ...
            <div class="row">
                <div class="grid_9 grid">
                    <ul id="jetmenu-2" class="jetmenu">
                        ...
                        <li style=""><a href="https://www.alumacraft.com/About-Alumacraft.php?content=about_us">About</a></li>
                        <li style=""><a href="https://www.alumacraft.com/About-Alumacraft.php?content=contact_us">Contact Us</a></li>
                        <li style=""><a href="https://www.alumacraft.com/About-Alumacraft.php?content=careers">Careers</a></li>
                        <li style=""><a href="https://www.alumacraft.com/About-Alumacraft.php?content=military">Military Discounts</a></li>
                        <li style=""><a href="http://www.alumacraft-gear.com" target="_blank">Gear</a></li>
                        <li style=""><a href="logout.php"><img src="https://www.alumacraft.com/images/icons/unLock.png" style="height:17px;"></a></li>
                    </ul>
                </div>
                ...
                <div class="grid_3 grid">
                    <div id="logo">
                        <a href="https://www.alumacraft.com/Alumacraft-Boats.php">
                        	<img src="https://www.alumacraft.com/images/logo.png?v=2" alt="Alumacraft logo" class="max-img">
                        </a>
                    </div>
                </div>
                <div class="grid_9 grid">
                    <ul id="jetmenu-1" class="jetmenu">
                        ...
                        <li style="">
                        	<a href="#">Specials</a>
                        		<ul class="dropdown" style="display: none;">
									<li>
										<a href="https://www.alumacraft.com/About-Alumacraft.php?content=military">Military Discounts</a>
										<br><span>A small token of our appreciation for those  who serve.</span>
									</li>
									<li>
										<a href="https://www.alumacraft.com/About-Alumacraft.php?content=promo-classic-165-cs">Classic CS</a>
										<br><span>$14,995 Boat, motor and trailer</span>
									</li>
									<li>
										<a href="https://www.alumacraft.com/About-Alumacraft.php?content=promo-prowler-175">Prowler 175</a>
                        ...
                        <li style="">
							...
							<ul class="dropdown" style="display: none;">
								<li><a href="https://www.alumacraft.com/About-Alumacraft.php?content=boats&amp;model_year=2018">2018 Models</a></li>
								<li><a href="https://www.alumacraft.com/About-Alumacraft.php?content=boats&amp;model_year=2017">2017 Models</a></li>
							</ul>
                        </li>
                        <li class="fix-sub" style="">
                            ...
                            <div class="megamenu full-width">
                                <div class="row">
                                    <div class="col6">
                                        <ul>
                                            <li><a href="https://www.alumacraft.com/About-Alumacraft.php?content=about_us">OUR LEGACY</a><br><span>We’ve been building industry-leading aluminum boats since 1946.</span></li>
                                            <li><a href="https://www.alumacraft.com/About-Alumacraft.php?content=construction">BETTER BUILT, BETTER RIDE, BETTER VALUE</a><br><span>Below the water line is where the ride begins. Learn about how we build our boats.</span></li>
                                            <li><a href="https://www.alumacraft.com/About-Alumacraft.php?content=warranty">OUR Warranty</a><br><span>We provide one of the best limited warranty programs available in the industry.</span></li>
                                            <li><a href="https://www.alumacraft.com/About-Alumacraft.php?content=options">OUR OPTIONS</a><br><span>Customize your new Alumacraft with all the bells and whistles you can imagine.</span></li>
                                            <li><a href="https://www.alumacraft.com/About-Alumacraft.php?content=ten_reasons">10 REASONS TO OWN AN ALUMACRAFT</a><br><span>Still haven’t made up your mind? Read up the the 10 reasons to own.</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="sec-menu" style="display: list-item;"><a href="https://www.alumacraft.com/About-Alumacraft.php?content=about_us">About</a></li>
                        <li class="sec-menu" style="display: list-item;"><a href="https://www.alumacraft.com/About-Alumacraft.php?content=contact_us">Contact Us</a></li>
                        <li class="sec-menu" style="display: list-item;"><a href="https://www.alumacraft.com/About-Alumacraft.php?content=careers">Careers</a></li>
                        <!--<li class="sec-menu"><a href="#">Resources</a></li>-->
                        <li class="sec-menu" style="display: list-item;"><a href="https://www.alumacraft.com/About-Alumacraft.php?content=military">Military Discounts</a></li>
