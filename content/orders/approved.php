    ...
    <thead>
    	<?php if ($boatsonly) : ?>
            <tr>
                ...
                <th class="sortable_table_header">PO</th> <th class="sortable_table_header">Status</th> <th class="sortable_table_header" >Order Date</th>  
                <th class="sortable_table_header" >Acknowledge Date</th>
            ...
            <?php foreach ($orders->fetchAll() as $order) : ?>
                ...
                <?php if ($boatsonly) : ?>
                    <tr>
                        ...
                        <?php //if (is_user_alumacraft_admin($userid)) : ?>
							<td><?php echo $prodfinish ?></td> <td><?php echo $requestrelease; ?></td>
						<?php //endif; ?>
